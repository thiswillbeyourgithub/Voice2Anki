...
from .logger import red, whi, yel, store_to_db, trace, timeout_60
...
assert Path("API_KEYS/OPENAI.txt").exists(), "No api key found"
client = OpenAI(api_key=str(Path("API_KEYS/OPENAI.txt").read_text()).strip())
